#!/usr/bin/env python3
"""Single Stage 8 arm2b training job entrypoint."""
...
from thesis.pilots.stage8_arm2b_runner import run_training_job  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    log_path = log_dir / f"seed_{args.master_seed}.log"
    try:
        ...
        print(f"FAILED seed={args.master_seed}: {exc}", file=sys.stderr)
        return 1
